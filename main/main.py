...
def main():
    ...
    def func_ask_for_score():
        ...
        while True:
            if ask_for_score == "y":
                score_index = (f"\nYou're choices have given you a difficulty score of {game_data["info"]["score"]}\n")
                print(score_index)
                break
            if ask_for_score == "n":
                print("Okay!")
    ...
    def zero_money():
        ...
        if game_data["info"]["starting_location"] == ("Nashville, Tennesee"):
            for i in str(user_broke):
                typing_animation()
        if game_data["info"]["starting_location"] == ("Champaign, Illinios"):
            for i in str(user_broke_1):
                typing_animation()
        if game_data["info"]["starting_location"] == ("New York, New York"):
    ...
    intro2 = (f"\nYou have ${game_data["info"]["money"]}\n")

    for i in str(intro2):
        typing_animation()

    beginning_location_dia1 = (f"\nIt is 1848. You are leaving from {game_data["info"]["starting_location"]} which is {game_data["info"]["distance"]} mi away from your final destination. You got a lot of ground to cover!")
        ...
        while True:
            ...
            if beginning_location_dia2.isdigit():
                ...
                if beginning_location_dia2 == 3:
                    game_data["info"]["score"] += 5
                    game_data["info"]["current_month"] = 5
                ...
                if beginning_location_dia2 == 4:
                    game_data["info"]["score"] += 7
                    game_data["info"]["current_month"] = 6
                ...
                if beginning_location_dia2 == 5:
                    game_data["info"]["score"] += 10
                    game_data["info"]["current_month"] = 7
        ...
        while True:
            ...
            if shop1_dia3.isdigit():
                ...
                if 2 <= shop1_dia3 < 11:
                    ...
                    game_data["info"]["money"] -= (100 * oxen_count)
                    if money < 0:
                        money = 0
            ...
            if shop1_dia4.isdigit():
                ...
                if shop1_dia4 <= 1:
                    ...
                    for i in str(food_dia1):
                        typing_animation()
                if 2 <= shop1_dia4 <= 100:
                    game_data["info"]["money"] -= (shop1_dia4 * 10)
                    game_data["items"]["lb_food"] += shop1_dia4
                    print (f"\nYou have purchased {shop1_dia4} lb of food with ${game_data["info"]["money"]} left.\n")
        ...
        while True:
            ...
            if shop1_dia5.isdigit():
                ...
                if 2 <= shop1_dia5 <= 10:
                    ...
                    game_data["info"]["money"] -= (shop1_dia5 * 20)
                    if game_data["info"]["money"] < 0:
                        game_data["info"]["money"] = 0
                    print(f"\nYou have purchased {shop1_dia5} sets of clothing with ${game_data["info"]["money"]} left.\n")
        ...
        while True:
            ...
            if shop1_dia6.isdigit():
                ...
                if 2 <= shop1_dia6 <= 500:
                    ...
                    game_data["info"]["money"] -= (shop1_dia6 * 1)
                    if game_data["info"]["money"] < 0:
                        game_data["info"]["money"] = 0
                    print(f"\nYou have purchased {shop1_dia6} bullets of ammunition with ${game_data["info"]["money"]} left.\n")
        ...
        while True:
            ...
            if shop1_dia7.isdigit():
                ...
                if  1 <= shop1_dia7 <= 4:
                    ...
                    game_data["info"]["money"] -= (shop1_dia7 * 250)
                    if game_data["info"]["money"] < 0:
                        game_data["info"]["money"] = 0
                    print(f"\nYou have purchased {shop1_dia7} sets of Spare Wagon Parts with ${game_data["info"]["money"]} left.\n")
    ...
    def intro_summary():
        ...
        summary_dai2 = (f"\nYou are leaving in the month of {chosen_month}.\nYou have ${game_data["info"]["money"]} left over.\nYou have {game_data["items"]["oxen_count"]} oxen.\nYou have {game_data["items"]["lb_food"]} lb of food.\nYou have {game_data["items"]["clothing"]} sets of clothing for you and your family.\nYou have {game_data["items"]["ammunition"]} bullets of ammunition.\nYou have {game_data["items"]["spare_parts"]} sets of spare parts for your wagon.")
    ...
    max_distance = game_data["info"]["distance"]

    # active game info
    active_game_info = {
        "player_distance": 0,
        "current_score": game_data["info"]["distance"],
    }

    # Game
    def game():
        while max(active_game_info["player_distance"]) < game_data["info"]["distance"]:
            game_data["current_score"] = game_data["info"]["score"]
